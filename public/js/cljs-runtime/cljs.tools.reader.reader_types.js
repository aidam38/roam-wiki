...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_26636 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_26636(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_26644 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_26644(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26646 = (function (reader,ch){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26646(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26647 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26647(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26648 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26648(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26653 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26653(reader);
}
});
...
var G__26695 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__26696 = s.append(c);
c = G__26695;
s = G__26696;
continue;
}
