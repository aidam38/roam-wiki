...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_31510 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_31510(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_31516 = (function (runtime,key,spec){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_31516(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_31517 = (function (runtime,key){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_31517(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_31521 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_31521(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_31531 = (function (runtime,input,callback){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_31531(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_31536 = (function (runtime,code){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_31536(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__31506,callback){
var map__31507 = p__31506;
var map__31507__$1 = cljs.core.__destructure_map(map__31507);
var input = map__31507__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31507__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31507__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
