...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__26563 = c;
var G__26563__$1 = (((G__26563 == null))?null:G__26563.prototype);
if((G__26563__$1 == null)){
return null;
} else {
return G__26563__$1.reagentRender;
}
})() == null)))));
});
...
while (G__26670__i < G__26670__a.length) {G__26670__a[G__26670__i] = arguments[G__26670__i + 0]; ++G__26670__i;}
  args = new cljs.core.IndexedSeq(G__26670__a,0,null);
} 
...
var or__4212__auto__ = (function (){var G__26573 = c;
var G__26573__$1 = (((G__26573 == null))?null:G__26573.constructor);
if((G__26573__$1 == null)){
return null;
} else {
return G__26573__$1.displayName;
}
})();
...
var G__26574 = c;
var G__26574__$1 = (((G__26574 == null))?null:G__26574.constructor);
if((G__26574__$1 == null)){
return null;
} else {
return G__26574__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__26577 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__26578 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__26578);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__26577);
}});
...
var c = this;
var G__26581_26675 = goog.object.get(c,"cljsRatom");
if((G__26581_26675 == null)){
} else {
reagent.ratom.dispose_BANG_(G__26581_26675);
}
...
var renders_26678 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_26679 = cljs.core.first(cljs.core.vals(renders_26678));
...
if((cljs.core.count(renders_26678) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_26678))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_26679)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_26679], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__26624 = o;
goog.object.set(G__26624,cljs.core.name(k),v);
...
return (function() { 
var G__26684__delegate = function (args){
return reagent.impl.protocols.as_element(compiler,cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args));
};
...
while (G__26685__i < G__26685__a.length) {G__26685__a[G__26685__i] = arguments[G__26685__i + 0]; ++G__26685__i;}
  args = new cljs.core.IndexedSeq(G__26685__a,0,null);
} 
...
var args = cljs.core.seq(arglist__26686);
...
var _STAR_current_component_STAR__orig_val__26659 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__26660 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__26660);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__26659);
}});
...
var vec__26661 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26661,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26661,(1),null);
...
var G__26664 = goog.object.get(reagent_state,"cljsRatom");
if((G__26664 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__26664);
}
});
}),[]);
