...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26706 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26706(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26710 = (function (port,val,fn1_handler){
var x__4509__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26710(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26714 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26714(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26715 = (function (chan){
var x__4509__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26715(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26719 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26719(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26720 = (function (h){
var x__4509__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26720(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_26721 = (function (h){
var x__4509__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_26721(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26722 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26722(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26724 = (function (b){
var x__4509__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26724(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26725 = (function (b,itm){
var x__4509__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26725(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26726 = (function (b){
var x__4509__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26726(b);
}
});
